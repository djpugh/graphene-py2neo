# -*- coding: utf-8 -*-
#
# graphene-py2neo documentation build configuration file, created by
...
from graphene_py2neo import __version__
...
htmlhelp_basename = 'graphene-py2neodoc'
...
latex_documents = [
  ('latex', 'graphene-py2neo.tex', u'graphene-py2neo',
...
man_pages = [
    ('man', 'graphene-py2neo', u'graphene-py2neo',
     [ __author__], 1)]
...
texinfo_documents = [
  ('index', 'graphene-py2neo', u'graphene-py2neo',
    __author__, 'graphene-py2neo', 'Integrate GraphQL into neo4j',
   'Miscellaneous'),
]
